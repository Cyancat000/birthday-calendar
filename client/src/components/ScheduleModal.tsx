...
export const ScheduleModal: React.FC<ScheduleModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl border border-zinc-200 overflow-hidden flex flex-col max-h-[90vh]"
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4 text-sm">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-xs font-semibold text-zinc-900">{date}</span>
            </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-xl focus:bg-white focus:outline-none focus:border-zinc-900 text-zinc-900 placeholder:text-zinc-400 transition"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-xs bg-zinc-50 border border-zinc-200 rounded-xl focus:bg-white focus:outline-none focus:border-zinc-900 text-zinc-900 placeholder:text-zinc-400 transition"
            />
          </div>
